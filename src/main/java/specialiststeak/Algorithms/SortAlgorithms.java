...
public class SortAlgorithms {
    ...
    /**
     * A method to test all the sorting algorithms real execution time, and rank them from fastest to slowest.
     *
     * @param array The array to sort
     * @param <T>  The type of the array. It must be comparable.
     */
    ...
    /**
     * A method to test all the sorting algorithms real execution time, and rank them from fastest to slowest.
     * This is different from the other testAll method as it runs n times and averages the runtime, leading to more
     * accurate results.
     *
     * @param array The array to sort
    ...
    /**
     * Method to print the results of the testAll method.
     *
     * @param arr The array of times to print
     */
